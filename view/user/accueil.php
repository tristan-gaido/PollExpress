        ...
        <section class="clean-block about-us">
            <div class="container">
                ...
                while ($donnees = $reponse->fetch() and $i<5) {
                    ...
                    echo '<div class="icons"><a href="https://webinfo.iutmontp.univ-montp2.fr/~gaidot/PollExpress/view/user/testclics.php?id=' . $donnees['id_sondage'] . '&lien=' . $donnees['lien'] . '"><button class="btn btn-primary" style="width: 138px;height: 43px;font-size: 10px;background: #2e86de;">Répondre au sondage</button></a></div>';
