    ...
    if (isset($_POST['inscription'])){ //test pour le formulaire "inscription"
      ...
      if($ok){
        ...
        $contenu = '<p>Bonjour ' . $reqtoken['pseudo'] . ',</p><br>
                    <p>Cliquez ici pour confirmer votre compte <a href="https://webinfo.iutmontp.univ-montp2.fr/~gaidot/PollExpress/index.php?action=verifmail&id=' . $reqtoken['id'] . '&token=' . $token . '">Valider</a><p>';
        ...
        header('Location: ./index.php?action=redirectionmail'); //redirection vers la page
        exit;
      }
    }
  }
