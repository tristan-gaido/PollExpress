            ...
            <form method="post" action="./index.php?action=login">
              ...
              ?>
                <div class="mb-3"><label class="form-label" for="email"><strong>Adresse Email</strong><br></label>
                  ...
                  ?>
                <div class="mb-3"><label class="form-label" for="password"><strong>Mot de passe </strong><a href="./index.php?action=resetmdp" style="color: #0C2461;">Mot de passe oublié</a><br></label>
                ...
                <div></div><small>Vous n'êtes pas encore inscrit ? <a href="./index.php?action=register" style="color: rgb(12,36,97);">S'inscrire</a></small>
            </form>
        </div>
    </section>
