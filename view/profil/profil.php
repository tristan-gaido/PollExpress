        ...
        <section class="clean-block clean-info dark" style="background: #dcdde1; padding-top: 80px;">
            <div class="container">
                <div class="block-heading">
                	<div class="tab">
                	<button class="tablinks" id="defaultOpen" onclick="openCity(event, 'Profil')">Profil</button>
                	<button class="tablinks"  onclick="openCity(event, 'Equipement')">Equipement</button>  
                	</div>
